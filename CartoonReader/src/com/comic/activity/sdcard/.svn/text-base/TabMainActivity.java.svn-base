...
public class TabMainActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LayoutInflater.from(this).inflate(R.layout.layout_tabmain, tabHost.getTabContentView());
		...
		spec1.setIndicator(getString(R.string.fileOpen),this.getResources().getDrawable(R.raw.fileopen));
		spec1.setContent(intent1);
		
		TabSpec spec2 = tabHost.newTabSpec("history");
		spec2.setIndicator(getString(R.string.recordHistory),this.getResources().getDrawable(R.raw.history));
