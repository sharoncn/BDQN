package rjfsdo.sharoncn.android.CartoonReaderWeb.CartoonReader.Dialog;
...
public class DefaultDialog extends AlertDialog.Builder{
	...
	private void init(){
		//点击确定后的事件
		this.setPositiveButton(R.string.bookmarkSubmit, new DialogInterface.OnClickListener() {
			@Override
		...
		//取消事件
		this.setNegativeButton(R.string.bookmarkCancel, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
			}
