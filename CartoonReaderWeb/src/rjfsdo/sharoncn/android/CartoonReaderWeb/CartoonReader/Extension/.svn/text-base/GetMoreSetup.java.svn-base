...
public class GetMoreSetup extends Dialog {
	...
	private void getPicRotate() {
		...
		view = (RelativeLayout) getLayoutInflater().inflate(R.layout.layout_image_rotate_cartoonreader, null);
	...
	private void getFixedTime() {
		//获取到保存的值
		View view = activity.getLayoutInflater().inflate(R.layout.layout_image_fixedtime_cartoonreader, null);
