...
import rjfsdo.sharoncn.android.BDQN.AptechWeibo.Adapter.CommentAdapter;
 ...
 *
 */
public class CommentListAct extends BaseActivity implements OnItemClickListener {
		...
		public void handleMessage(Message msg) {
			...
			case WeiboDataManager.MSGTYPE_PARSECONTENT:
				...
				if (bundle.getBoolean(WeiboDataManager.FLAG_ISSUCCESS)) {
					...
					Util.showMsg(CommentListAct.this, getString(R.string.getdata_fail) + bundle.getString(WeiboDataManager.FLAG_ERR_MSG));
				}
				break;
			}
	...
	public void onItemClick(AdapterView<?> adpView, View view, int position, long id) {
		if (position == adapter.getCount() - 1) {
			if (moreView != null) {
				Util.showMsg(CommentListAct.this, R.string.loading);
	...
	private void refresh(int page) {
		...
		WeiboDataManager.getInstance(this).getComments(holder, page);
	}
}
